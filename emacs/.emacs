...
(custom-set-faces
 ...
 '(company-tooltip-scrollbar-track ((t (:background "dark sea green"))))
 '(company-tooltip-selection ((t (:background "DarkOrange4"))))
